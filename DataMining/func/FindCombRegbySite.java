 ...
 * Time: 10:29 AM
 */
public class FindCombRegbySite {
    ...
    double minoverlap = 0.1;//0.2;0.01;//
    ...
    //ArrayList globalcountpval_list;
    //ArrayList globalcountpval_key;
     ...
     * @param args
     */
    public FindCombRegbySite(String[] args) {

        init(args);

        double expected_maximal_number_of_data = 1000000000d;
        int capacity = (int) ((expected_maximal_number_of_data) / 0.75 + 1);
        globalcountpval = new THashMap<String, String>(capacity);

        //globalcountpval_key = new ArrayList();
        //globalcountpval_list = new ArrayList();

        Set overmapSet = loadCounts();

        String outpath = args[4] + "_combreg_" + minoverlap + "_" + this.pvalue_cutoff + ".txt";
        TextFile.write(out, outpath);
        System.out.println("outpath " + outpath);

        if (irv != null) {
            System.out.println("adjustPvals bf");
            adjustPvals();
            System.out.println("adjustPvals af");
        }
        //for testing only
        else {
            pvals_adjust = MoreArray.ArrayListtoDouble(pvals_raw);
        }
        ArrayList outglobalpval = null;
        Set sglobal = null;
        Iterator itglobal = null;
        HashMap finalglobalcountpval = null;

        //redo global with adjusted pvalue filter
        outglobalpval = new ArrayList();

/*        for (int i = 0; i < globalcountpval_list.size(); i++) {

            String key = (String) globalcountpval_key.get(i);
            String val = (String) globalcountpval_list.get(i);
            try {
                int x = (Integer) pval_index.get(key);
                double adjustpval = pvals_adjust[x];
                if (adjustpval < pvalue_cutoff) {
                    finalglobalcountpval.put(key, val + ":" + adjustpval);
                }
            } catch (Exception e) {
        ...
        while (itglobal.hasNext()) {
            ...
            outglobalpval.add(key + "\t" + vbone + "\t" + vbtwo + "\t" + bics + "\t" + TFs + "\t" + TFsar[0] + "\t" + TFsar[1] + "\t" + MoreArray.toString(value.split(":"), "\t"));
        }

        if (!minimal) {
            String outpath2 = args[4] + "_signifcombreg_" + minoverlap + "_" + this.pvalue_cutoff + ".txt";
            ...
            String outpath5 = args[4] + "_intersectgenes_" + minoverlap + "_" + this.pvalue_cutoff + ".txt";
            ...
            String outpath5a = args[4] + "_Rgenes_" + minoverlap + "_" + this.pvalue_cutoff + ".txt";
            ...
            String outpath5b = args[4] + "_Lgenes_" + minoverlap + "_" + this.pvalue_cutoff + ".txt";
            ...
            String outpath6 = args[4] + "_intersectexp_" + minoverlap + "_" + this.pvalue_cutoff + ".txt";
            ...
            TextFile.write(outglobal, args[4] + "_combregstats_" + minoverlap + "_" + this.pvalue_cutoff + ".txt");
            String outpath3 = args[4] + "_combregstatsall_" + minoverlap + "_" + this.pvalue_cutoff + ".txt";
            ...
            if (intersect_vbl.size() > 0) {
                ...
                String outpath7 = args[4] + "_intersect_" + minoverlap + "_" + this.pvalue_cutoff + ".vbl";
                System.out.println("writing " + outpath7);
                TextFile.write(stoplist, outpath7);
            }

            String outpath9 = args[4] + "_intersect_names_" + minoverlap + "_" + this.pvalue_cutoff + ".txt";
...
//                    MoreArray.printArray(TFtwo);
    ...
    private boolean doGlobalCount(String vbpair, String key, String dir, boolean combpair, int intersectgenes,
        ...
        while (it2.hasNext()) {
            ...
            combpair = true;
            out_str = dir + "\t" + key + "\t" + cur.getKey() + "\t" + (Integer) cur.getValue() + "\t" + frxn + "\t" + label;
    ...
    public static void main(String[] args) {
        if (args.length == 8 || args.length == 9) {
            FindCombRegbySite rm = new FindCombRegbySite(args);
        } else {

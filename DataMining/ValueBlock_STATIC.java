...
public final class ValueBlock_STATIC {
    ...
    public final static String[] criteria_labels = {"expr_MEAN", "expr_MSE", "expr_FEM", "expr_KEND",
            "expr_COR", "expr_EUC", "expr_SPEARMAN", "PPI", "feat", "minTF"};
    ...
    public final static int expr_SPEARMAN_IND = 6;
    public final static int interact_IND = 7;
    public final static int feat_IND = 8;
    public final static int TF_IND = 9;

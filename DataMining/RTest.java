   ...
   to accomplish what you want */
        try {
            ...
            if (k != null) {
                ...
                int i = 0;
                while (i < k.length) System.out.println(k[i++]);
            }
        ...
        // we could use assign and then idleEval "b<-data.frame(b)", but for now let's build it by hand:
        String rn[] = {"1", "2", "3"};
...

        {
            ...
            System.out.println("Result = " + e + ", running idleEval");

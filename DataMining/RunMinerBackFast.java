...
public class RunMinerBackFast {
     ...
     * @param p
     */
    public RunMinerBackFast(Parameters p) {
        orig_prm = p;
        if (orig_prm != null) {
            initBack();
            run();
     ...
     * @param d
     */
    public RunMinerBackFast(Parameters p, SystemResource s, int d) {
        sysRes = s;
        debug = d;
        orig_prm = p;
        if (orig_prm != null) {
     ...
     * @param d
     */
    public RunMinerBackFast(Parameters p, SystemResource s, int d, Integer wt) {
        sysRes = s;
        debug = d;
        walltime = wt;
        orig_prm = p;
     ...
     * @param parameterpath
     */
    public RunMinerBackFast(String parameterpath) {
        init(parameterpath);
        run();
    }
     ...
     * @param parameterpath
     */
    public RunMinerBackFast(String parameterpath, SystemResource s) {
     ...
     * @param parameterpath
     */
    public RunMinerBackFast(String parameterpath, SystemResource s, Integer wt) {
        debug = MINER_STATIC.DEFAULT_DEBUG;
        sysRes = s;
        walltime = wt;
        init(parameterpath);
     ...
     * @param parameterpath
     */
    public RunMinerBackFast(String parameterpath, SystemResource s, boolean r) {
        sysRes = s;
        run = r;
     ...
     * @param parameterpath
     */
    public RunMinerBackFast(String parameterpath, boolean r) {
        run = r;
        System.out.println("RunMinerBack run? " + r);
        init(parameterpath);
        if (run)
     ...
     * @param d
     */
    public RunMinerBackFast(String parameterpath, SystemResource s, int d) {
        sysRes = s;
        debug = d;
        init(parameterpath);
     ...
     * @param d
     */
    public RunMinerBackFast(String parameterpath, SystemResource s, int d, Integer wt) {
        sysRes = s;
        debug = d;
        walltime = wt;
        init(parameterpath);
     ...
     * @param d
     */
    public RunMinerBackFast(String parameterpath, SystemResource s, int d, boolean r) {
        sysRes = s;
        debug = d;
        run = r;
        init(parameterpath);
     ...
     * @param m
     */
    public RunMinerBackFast(MinerViewBack m) {
        mvb = m;
        orig_prm = mvb.prm;
    ...
    public ArrayList evaluateVSTrue(double[] start, double[] end) {
        ...
        ar.add(evaluateVSTrueStart(start[0], start[1], start[2], start[3], start[4], start[5], start[6], start[7], start[7], start[8]));
        ar.add(evaluateVSTrueFinalClosest(end[0], end[1], end[2], end[3], end[4], end[5], end[6], end[7], end[7], end[8]));
        return ar;
    }
    ...
    private void testInputFiles() {
        ...
        System.out.println("testInputFiles " + exit);
        if (exit) {
            System.out.println("missing key components, existing");
            System.exit(0);
        }
    }
        ...
        if (orig_prm.EXCLUDE_LIST_PATH != null) {
            ...
            if (test.exists()) {
                ...
                if (exclude_vbl == null || exclude_vbl.size() == 0)
                    ...
                    System.out.println("exclude_vbl " + exclude_list.size());
                }
                //}
            }
        }

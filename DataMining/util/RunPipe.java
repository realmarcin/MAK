...
public class RunPipe {
    ...
    public RunPipe(String[] args) {
        ...
        try {
            ...
            String s1 = "java -mx64000M DataMining.BlockMembers " + cutlistname + " members_" + totallistname + " __MSEC_KendallC_FEMC__ &> BlockMembers_top.out";
            ...
            String s5 = "java -mx2000M DataMining.TreeMergeMembers hclust_block_cut_" + cutlistname + ".txt " + cutlistfile + " hclust_block_cut_" + cutlistname + "_merged.txt __MSEC_Kendall_FEMC__ 6160 667 &> TreeMergeMembers.out";
            System.out.println(s5);
            P = R.exec(s5);
            P.waitFor();

            String s6 = "java DataMining.util.ScoreBlocks -bic hclust_block_cut_" + cutlistname + "_merged.txt -tab 4932.tab -param yeast_cmonkey_weighexpr_parameters.txt -goyeast go_slim_mapping.tab -GOT localization_terms.tab -TF mccord_ranks.txt -TFREF RegulationMatrix_Documented_20101213.txt -crit MSEC_KendallC_FEMC  &> score_C_merged.out";
            System.out.println(s6);
            P = R.exec(s6);
            P.waitFor();

            String s7 = "java DataMining.SelectMerged results_yeast_cmonkey_1_expr_round1_top0.01_5percstart.txt hclust_block_cut_" + cutlistname + "_merged_MSEC_KendallC_FEMC.txt " + cutlistname + "_merged_select.vbl &> SelectMerged.out";
...
java -mx64000M DataMining.BlockMembers results_yeast_cmonkey_1_expr_round1_topcutfromr2_5percstart.txt members_MSEC_KendallC_FEMC_yeast_topcutfrom2 __MSEC_KendallC_FEMC__ &> BlockMembers_top.out
...
java -mx2000M DataMining.TreeMergeMembers hclust_block_cut_results_yeast_cmonkey_1_expr_mergedround1_top0.01_5percstart__MSEC_KendallC_FEMC.txt results_yeast_cmonkey_1_expr_round1_top0.01_5percstart.txt hclust_block_cut_MSEC_Kendall_FEMC_top0.01_5percstart_round1_merged.txt __MSEC_Kendall_FEMC__ 6160 667 &> TreeMergeMembers.out

java DataMining.util.ScoreBlocks -bic hclust_block_cut_MSEC_Kendall_FEMC_top0.01_5percstart_round1_merged.txt -tab 4932.tab -param yeast_cmonkey_weighexpr_parameters.txt -goyeast go_slim_mapping.tab -GOT localization_terms.tab -TF mccord_ranks.txt -TFREF RegulationMatrix_Documented_20101213.txt -crit MSEC_KendallC_FEMC  &> score_C_merged.out

java DataMining.SelectMerged results_yeast_cmonkey_1_expr_round1_top0.01_5percstart.txt hclust_block_cut_MSEC_Kendall_FEMC_top0.01_5percstart_round1_merged_MSEC_KendallC_FEMC.txt results_yeast_cmonkey_1_expr_round1_top_merged_select.vbl &> SelectMerged.out

...
axis <- "c"#c_over"
firstlabel <- paste("fake",axis,"_",sep="")
orient <- toupper(axis)

#inpath <- paste("~/Documents/integr8_genom/Miner/miner_results/eval/eval/eval_fakec_incr_nono_noabs_v7",sep="")#eval_",firstlabel,"over_001_absSTART_fastcluster_10to_40_v2", sep="")
inpath <- paste("~/Documents/integr8_genom/Miner/miner_results/eval/synth_evaluation/synth_c_const_nono",sep="")

source("c:/projects/integr8_genom/Miner/miner_results/external_evaluation_batch_r_const_incr_methods.R")

doSeriesScatter("r_incr","r_incr_pG")
doSeriesScatter("r_incr_pG","r_incr_pG_metro")
doSeriesScatter("r_incr","r_incr_pG_metro")
doSeriesScatter("r_incr_pG_metro","r_incr_pG_metro_10pre")
doSeriesScatter("r_incr_pG_metro","r_incr_pG_metro_10pre_rand")
doSeriesScatter("r_incr_pG_metro_10pre_rand","r_incr_pG_metro_10pre_randgene")
doSeriesScatter("r_incr_pG_metro_10pre_rand","r_incr_pG_metro_10pre_randexp")
doSeriesScatter("r_incr_pG_metro_10pre_randgene","r_incr_pG_metro_10pre_randexp")
...
doSeries("r_incr_pG_metro_10pre_randexp")
doSeries("r_incr_pG_5percprecrit")
...
doSeries("r_incr_nono_pG_metro_rand")

...
"MSEC_LASRE", "MSEC_GEERE_PPI", "MSEC_GEERE", "LARSRE_PPI", 

"LARSCE","GEECE_PPI", "GEECE","MSER_LARSCE_PPI","MADR_LARSCE_PPI","Kendall_LARSCE_PPI", "MSER_LARSCE","MADR_LARSCE","Kendall_LARSCE", 
"MSER_GEECE_PPI", "MADR_GEECE_PPI", "Kendall_GEECE_PPI", "MSER_GEECE", "MADR_GEECE", "Kendall_GEECE","MSE_LARSCE_PPI", 
"MSE_LARSCE", "MSE_GEECE_PPI", "MSE_GEECE", "MSEC_LARSCE_PPI", 
"MSEC_LASRE", "MSEC_GEECE_PPI", "MSEC_GEECE", "LARSCE_PPI")

print(paste("criteria",length(criteria)))

setwd("c:/projects/integr8_genom/Miner/miner_results")
source("ROC_analysis_ALL_methods.R")
setwd("c:/projects/integr8_genom/Miner/miner_results/ROC_r_incr_nono_rand_pG_batch_metro_final_batchsinglerandom/")
